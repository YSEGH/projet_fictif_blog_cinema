...
<div class="row d-flex justify-content-center my-2 p-3">
    <div class="movie_page-infos col-md-3 col-12 p-2" style="height: auto;">
    ...
    <div class="movie_page-resume col-md-4 col-12 p-3">
        ...
        <p class="text-white text-justify font-weight-lighter mb-3"><?= $movie->resume ?></p>
        <p class="font-weight-lighter text-justify text-left text-white my-1"><span class="font-weight-normal">Réalisateur : </span><?= $movie->realisator ?></p>
        <p class="font-weight-lighter text-justify text-left text-white my-1"><span class="font-weight-normal">Acteurs : </span><?= $movie->actor ?></p>
        <p class="font-weight-lighter text-justify text-left text-white my-1"><span class="font-weight-normal">Date de sortie : </span><?= $movie->release_date ?></p>
