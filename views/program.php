...
<div class="row justify-content-center align-items-center mt-4" style="height: auto;">
  <h3 class="text-white text-uppercase text-center font-weight-light"><i class="fa fa-film p-1" aria-hidden="true"></i> Programme du <?= $seances[0]->getProgram()->format('d F Y') ?></h3>
</div>  
...
<div class="row justify-content-center align-items-center mt-4 mb-5 px-3">
<?php foreach ($movies[0] as $movie) : ?>
    <div class="col-md-2 col-12 d-flex flex-column align-items-center justify-content-center">
