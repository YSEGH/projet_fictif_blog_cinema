...
<div class="row d-flex justify-content-center my-5">
    <form action="" method="POST" class="col-12 d-flex flex-wrap align-items-center justify-content-center mx-auto">
        ...
        <div class="col-12 d-flex flex-column justify-content-center mt-5 ">
            <a href="<?= $router->generate('password_update')?>" class="col-2 align-self-start btn btn-secondary font-weight-lighter rounded-0 mt-auto my-2 mx-auto">Modifier mon mot de passe</a>  
            <button type="submit" class="col-2 btn btn-dark font-weight-lighter rounded-0 m-auto" style="background-color: #EF6962;">Valider les modifications</button>    
        </div>
    </form>
</div>
