...
<section class="section-gestion-news container align-self-start my-4">
    <div class="d-flex justify-content-between">
        <h1 class="mb-3 text-uppercase text-dark font-weight-light">Liste des films</h1>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-middle"><a href="<?= $router->generate('update_movie', ['slug' => $movie->slug, 'id' => $movie->id]) ?>" class="btn btn-primary font-weight-lighter rounded-0 ">Modifier</a></td>
            <td class="align-middle"><a href="<?= $router->generate('delete_movie', ['slug' => $movie->slug, 'id' => $movie->id]) ?>" class="btn btn-danger font-weight-lighter rounded-0 ">Supprimer</a></td>
        </tr>
        <?php endforeach ?>
    </tbody>
    </table>
