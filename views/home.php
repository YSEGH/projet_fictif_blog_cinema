...
<div class="row align-items-center" style="height: 11vh;">
...
<div id="carouselExampleSlidesOnly" class=" carousel slide mt-3 pt-5 mx-auto" data-ride="carousel">
...
<div class="row d-flex justify-content-center">
  <?php for ($i=12; $i < 17; $i++) : ?>
    <a class="col-md-2 col-sm-3 col-5 link-homepage-program my-2 mx-2 d-flex justify-content-center align-items-center" style="max-height:10rem; min-height:10rem;max-width:10rem; min-width:10rem;">
      <h3><?= $i ?> - Oct</h3>
    </a>
  <?php endfor ?>
</div>
...
<div class="photo-festival row d-flex justify-content-center m-0" style="min-height:80vh;">
    <div class="p-3 col-md-3 col-12 photo-1 bg-primary d-flex justify-content-start align-items-end" style="background-image:url('<?= $movie_1->photo ?>');"><h5 class="col-auto p-3 text-white text-center font-weight-normal" style="background-color: #131313;"><?= $movie_1->name ?> <span class="font-weight-lighter">- <?= $movie_1->realisator ?></span></h5></div>
